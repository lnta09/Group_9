  ...
  <div id="myCarousel" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner">
      ...
      <div class="item active">
        <img src="img/Panel1.jpg" alt="Los Angeles" style="width:100%;">
      ...
      <div class="item">
        <img src="img/Panel1.jpg" alt="New York" style="width:100%;">
      ...
      <div class="item">
        <img src="img/Panel3.jpg" alt="New York" style="width:100%;">
				...
				<div class="row">
					...
					<div class="col-md-4 col-xs-6">
						<a href="product.php?p=78"><div class="shop">
							<div class="shop-img">
								<img src="./img/shop1.jpg" alt="" width="300" height="200">
							</div>
							<div class="shop-body">
								<h3>Dining room<br>Collection</h3>
					...
					<div class="col-md-4 col-xs-6">
						<a href="product.php?p=72"><div class="shop">
							<div class="shop-img">
								<img src="./img/shop2.jpg" alt="" width="300" height="200">
							</div>
							<div class="shop-body">
								<h3>Office<br>Collection</h3>
					...
					<div class="col-md-4 col-xs-6">
						<a href="product.php?p=79"><div class="shop">
							<div class="shop-img">
								<img src="./img/shop3.jpg" alt="" width="300" height="200">
							</div>
							<div class="shop-body">
						...
						<div class="section-title">
							...
							<div class="section-nav">
								<ul class="section-tab-nav tab-nav">
									<li class="active"><a data-toggle="tab" href="#tab1">Ling room</a></li>
									<li><a data-toggle="tab" href="#tab1">Dining room</a></li>
									<li><a data-toggle="tab" href="#tab1">Bedroom</a></li>
									<li><a data-toggle="tab" href="#tab1">Office</a></li>
									<li><a data-toggle="tab" href="#tab1">Decorations</a></li>
								</ul>
							</div>
						</div>
					</div>
